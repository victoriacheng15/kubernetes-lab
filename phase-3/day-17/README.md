...
1. **Create the Namespace:**
   ...
   ```bash
   kubectl apply -f phase-3/day-17/manifests/01-namespace.yaml
   ```

2. **Deploy the Simple Job:**

   ```bash
   kubectl apply -f phase-3/day-17/manifests/02-simple-job.yaml
   ```
...
4. **Deploy the Parallel Job:**
   ...
   ```bash
   kubectl apply -f phase-3/day-17/manifests/03-parallel-job.yaml
   ```
...
6. **Deploy the CronJob:**
   ...
   ```bash
   kubectl apply -f phase-3/day-17/manifests/04-cronjob.yaml
   ```
