...
1. **Create the Namespace:**
   ...
   ```bash
   kubectl apply -f phase-3/day-15/manifests/01-namespace.yaml
   ```

2. **Create the ServiceAccount and RBAC Rules:**

   ```bash
   kubectl apply -f phase-3/day-15/manifests/02-serviceaccount.yaml
   kubectl apply -f phase-3/day-15/manifests/03-role.yaml
   kubectl apply -f phase-3/day-15/manifests/04-rolebinding.yaml
   kubectl apply -f phase-3/day-15/manifests/05-clusterrole.yaml
   kubectl apply -f phase-3/day-15/manifests/06-clusterrolebinding.yaml
   ```

3. **Deploy the Test Pod:**

   ```bash
   kubectl apply -f phase-3/day-15/manifests/07-debug-pod.yaml
