...
1. **Create the Namespace:**
   ...
   ```bash
   kubectl apply -f phase-3/day-16/manifests/01-namespace.yaml
   ```

2. **Deploy the Liveness Probe Pod:**

   ```bash
   kubectl apply -f phase-3/day-16/manifests/02-liveness-pod.yaml
   ```
...
4. **Deploy the Readiness Pod and Service:**
   ...
   ```bash
   kubectl apply -f phase-3/day-16/manifests/03-readiness-pod.yaml
   kubectl apply -f phase-3/day-16/manifests/04-service.yaml
   ```
...
6. **Deploy the Startup Probe Pod:**
   ...
   ```bash
   kubectl apply -f phase-3/day-16/manifests/05-startup-pod.yaml
   ```
