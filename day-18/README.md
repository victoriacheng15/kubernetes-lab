...
2. **Create the Namespace:**
   ...
   ```bash
   kubectl apply -f day-18/manifests/01-namespace.yaml
   ```

3. **Deploy the Web Server and Service:**

   ```bash
   kubectl apply -f day-18/manifests/02-deployment.yaml
   kubectl apply -f day-18/manifests/03-service.yaml
   ```

4. **Deploy the HPA:**

   ```bash
   kubectl apply -f day-18/manifests/04-hpa.yaml
   ```
...
5. **Generate Load:**
   ...
   ```bash
   kubectl apply -f day-18/manifests/05-load-generator.yaml
   ```
