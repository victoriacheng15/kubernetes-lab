...
## Services, DNS, and Service Discovery
...
```mermaid
flowchart TD
    Client[User / Client Request] -->|Hits Stable Service IP or DNS| Service[Kubernetes Service<br>ClusterIP / DNS]
    Service -->|Dynamic Load Balancing| PodA[Backend Pod A<br>IP: 10.244.0.1]
    Service -->|Dynamic Load Balancing| PodB[Backend Pod B<br>IP: 10.244.0.2]
```
...
## Lab: Service Discovery and DNS Resolution
