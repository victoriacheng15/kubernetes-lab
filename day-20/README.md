...
1. **Create the Namespace:**
   ...
   ```bash
   kubectl apply -f day-20/manifests/01-namespace.yaml
   ```

2. **Deploy the Standard Pod:**

   ```bash
   kubectl apply -f day-20/manifests/02-standard-pod.yaml
   ```
...
4. **Deploy the Distroless/Minimal Pod:**
   ...
   ```bash
   kubectl apply -f day-20/manifests/03-distroless-pod.yaml
   ```
