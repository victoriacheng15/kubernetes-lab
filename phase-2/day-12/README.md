...
1. **Create the Namespace:**
    ...
    ```bash
    kubectl apply -f phase-2/day-12/manifests/01-namespace.yaml
    ```
...
2. **Deploy the Workloads:**
    ...
    ```bash
    kubectl apply -f phase-2/day-12/manifests/02-pod-db.yaml
    kubectl apply -f phase-2/day-12/manifests/03-pod-frontend.yaml
    kubectl apply -f phase-2/day-12/manifests/04-pod-unauthorized.yaml
    ```
...
4. **Isolate the Database (Apply NetworkPolicy):**
    ...
    ```bash
    kubectl apply -f phase-2/day-12/manifests/05-policy-secure-db.yaml
    ```
