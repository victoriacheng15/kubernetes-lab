...
1. **Create the Namespace:**
    ...
    ```bash
    kubectl apply -f phase-2/day-10/manifests/01-namespace.yaml
    ```
...
3. **Deploy a Pod without Tolerations:**
    ...
    ```bash
    kubectl apply -f phase-2/day-10/manifests/02-pod-un-tolerated.yaml
    ```
...
4. **Deploy a Pod with Matching Tolerations:**
    ...
    ```bash
    kubectl apply -f phase-2/day-10/manifests/03-pod-tolerated.yaml
    ```
