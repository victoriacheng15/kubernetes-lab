...
The initial manifests located in `phase-2/day-14/manifests/broken/` contain three deliberate configuration errors. Use your troubleshooting skills to identify and fix:
...
```diff
--- phase-2/day-14/manifests/broken/02-storage.yaml
+++ phase-2/day-14/manifests/fixed/02-storage.yaml
@@ -12,2 +12,2 @@
...
```diff
--- phase-2/day-14/manifests/broken/04-frontend.yaml
+++ phase-2/day-14/manifests/fixed/04-frontend.yaml
@@ -7,2 +7,2 @@
-    app: guestbook-web
+    app: frontend
@@ -25,2 +25,2 @@
...
```diff
--- phase-2/day-14/manifests/broken/06-ingress.yaml
+++ phase-2/day-14/manifests/fixed/06-ingress.yaml
@@ -17,1 +17,1 @@
-              number: 8080
+              number: 80
```
...
1. **Apply the Broken Manifests:**
   ...
   ```bash
   kubectl apply -f phase-2/day-14/manifests/broken/01-namespace.yaml
   kubectl apply -f phase-2/day-14/manifests/broken/02-storage.yaml
   kubectl apply -f phase-2/day-14/manifests/broken/03-redis-db.yaml
   kubectl apply -f phase-2/day-14/manifests/broken/04-frontend.yaml
   kubectl apply -f phase-2/day-14/manifests/broken/05-networkpolicy.yaml
   kubectl apply -f phase-2/day-14/manifests/broken/06-ingress.yaml
   ```
...
1. **Apply the Fixed Manifests:**
   ...
   ```bash
   kubectl apply -f phase-2/day-14/manifests/fixed/01-namespace.yaml
   kubectl apply -f phase-2/day-14/manifests/fixed/02-storage.yaml
   kubectl apply -f phase-2/day-14/manifests/fixed/03-redis-db.yaml
   kubectl apply -f phase-2/day-14/manifests/fixed/04-frontend.yaml
   kubectl apply -f phase-2/day-14/manifests/fixed/05-networkpolicy.yaml
   kubectl apply -f phase-2/day-14/manifests/fixed/06-ingress.yaml
   ```
