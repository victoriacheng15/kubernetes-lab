...
1. **Create the Namespace:**
    ...
    ```bash
    kubectl apply -f phase-2/day-09/manifests/01-namespace.yaml
    ```
...
3. **Deploy the NodeSelector Pod:**
    ...
    ```bash
    kubectl apply -f phase-2/day-09/manifests/02-pod-nodeselector.yaml
    ```
...
4. **Deploy the NodeAffinity Pod:**
    ...
    ```bash
    kubectl apply -f phase-2/day-09/manifests/03-pod-nodeaffinity.yaml
    ```
...
5. **Deploy PodAffinity (Co-location):**
    ...
    ```bash
    kubectl apply -f phase-2/day-09/manifests/04-pod-db.yaml
    ```
    ...
    ```bash
    kubectl apply -f phase-2/day-09/manifests/05-pod-podaffinity.yaml
    ```
...
6. **Deploy PodAntiAffinity (HA Distribution):**
    ...
    ```bash
    kubectl apply -f phase-2/day-09/manifests/06-pod-podantiaffinity.yaml
    ```
