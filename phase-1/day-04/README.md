...
1. **Deploy the Web Application:**
   ...
   ```bash
   kubectl apply -f phase-1/day-04/manifests/01-deployment.yaml
   ```
...
2. **Expose internally via ClusterIP:**
   ...
   ```bash
   kubectl apply -f phase-1/day-04/manifests/02-clusterip.yaml
   ```
...
3. **Expose externally via NodePort:**
   ...
   ```bash
   kubectl apply -f phase-1/day-04/manifests/03-nodeport.yaml
   ```
...
5. **Clean Up:**
   ...
   ```bash
   kubectl delete -f phase-1/day-04/manifests/
   ```
