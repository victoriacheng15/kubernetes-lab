...
A practical, day-by-day lab guide for deepening Kubernetes concepts through focused labs, troubleshooting, and reusable notes.
...
- [Day 01](phase-1/day-01/README.md) - Objective: Understand cluster architecture and core components.
- [Day 02](phase-1/day-02/README.md) - Objective: Deep dive into Pods, lifecycle, restarts, and init containers.
- [Day 03](phase-1/day-03/README.md) - Objective: Understand Deployments, ReplicaSets, DaemonSets, StatefulSets, rollouts, and rollbacks.
- [Day 04](phase-1/day-04/README.md) - Objective: Explore Services, DNS, and service discovery.
- [Day 05](phase-1/day-05/README.md) - Objective: Use ConfigMaps and Secrets for application configuration.
- [Day 06](phase-1/day-06/README.md) - Objective: Practice Namespaces, ResourceQuotas, and LimitRanges.
- [Day 07](phase-1/day-07/README.md) - Project 1: Deploy and troubleshoot a basic multi-pod application.
...
- [Day 08](phase-2/day-08/README.md) - Objective: Understand resource requests, limits, and QoS classes.
- [Day 09](phase-2/day-09/README.md) - Objective: Practice scheduling with node selectors, affinity, and anti-affinity.
- [Day 10](phase-2/day-10/README.md) - Objective: Use taints and tolerations for scheduling control.
- [Day 11](phase-2/day-11/README.md) - Objective: Explore PersistentVolumes, PVCs, and StorageClasses.
- [Day 12](phase-2/day-12/README.md) - Objective: Build NetworkPolicies for ingress and egress control.
- [Day 13](phase-2/day-13/README.md) - Objective: Configure Ingress and HTTP routing.
- [Day 14](phase-2/day-14/README.md) - Project 2: Build and troubleshoot a networked application with storage.
...
- [Day 15](phase-3/day-15/README.md) - Objective: Understand RBAC, ServiceAccounts, Roles, ClusterRoles, and bindings.
- [Day 16](phase-3/day-16/README.md) - Objective: Configure liveness, readiness, and startup probes.
- [Day 17](phase-3/day-17/README.md) - Objective: Run Jobs and CronJobs.
- [Day 18](phase-3/day-18/README.md) - Objective: Configure Horizontal Pod Autoscaling.
- [Day 19](phase-3/day-19/README.md) - Objective: Correlate logs, metrics, events, pod conditions, and node conditions.
- [Day 20](phase-3/day-20/README.md) - Objective: Debug containers with exec and ephemeral containers.
- [Day 21](phase-3/day-21/README.md) - Project 3: Deploy a secure, observable, autoscaling application.
